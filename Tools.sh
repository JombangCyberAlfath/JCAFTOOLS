...
echo "\033[34;1m Selamat Datang di Tools Forgott3n_18x"
...
echo $cyan" ["$red"+"$cyan"]Author by	: Forgott3n_18x"

echo $cyan" ["$red"+"$cyan"]Team : Indonesia Security Lite dan Jombang Cyber Al-Fath	"
...
git clone https://github.com/JombangCyberAlfath/JCAFDDOS
...
git clone https://github.com/JombangCyberAlfath/JCAFMBF
...
git clone https://github.com/JombangCyberAlfath/JCAF
